...
public class ManagDocuments extends AppCompatActivity {
   ...
   upload.setOnClickListener(new View.OnClickListener() {
       ...
       public void onClick(View v) {
        ...
        Rview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ManagDocuments.this,DocumentsRecycleShow.class);
    ...
    private void PickImaggalarry() {
        Dexter.withActivity(ManagDocuments.this)
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse response) {
                        Toast.makeText(ManagDocuments.this, "No"+response, Toast.LENGTH_SHORT).show();
                    }
        ...
        StorageReference uploader = storageReference.child(System.currentTimeMillis()
            ...
            uploader.putFile(filepath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(ManagDocuments.this, "Upload successful!", Toast.LENGTH_LONG).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ManagDocuments.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });}
        else 
        {
