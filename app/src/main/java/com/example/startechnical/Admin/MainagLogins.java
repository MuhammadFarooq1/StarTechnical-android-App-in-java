...
public class MainagLogins extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_SeeAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent manage_login = new Intent(MainagLogins.this, AdminProfile.class);
            ...
            firebaseDatabase.child(etid_name).setValue(Password)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(MainagLogins.this, " Added Success ", Toast.LENGTH_LONG).show();
                            etid_Name.setText("");
                            etid_PhNo.setText("");
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(MainagLogins.this, " Failed To Enter ", Toast.LENGTH_LONG).show();
                }
            }).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
                public void onComplete(@NonNull com.google.android.gms.tasks.Task<Void> task) {
                    Toast.makeText(MainagLogins.this, "Finance  Added Success ", Toast.LENGTH_LONG).show();
