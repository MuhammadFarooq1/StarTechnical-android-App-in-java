...
import com.example.startechnical.Admin.AddTasks;
import com.example.startechnical.Admin.MainagLogins;
import com.example.startechnical.Admin.ManagDocuments;
import com.example.startechnical.Admin.ManagSpecialCustomer;
import com.example.startechnical.Admin.Manag_Profile;
import com.example.startechnical.Admin.ManageFinance;
...
import com.example.startechnical.BuildConfig;
...
public class Dash_board extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SumToatalExp();
        SumProfit();
        if(ContextCompat.checkSelfPermission(Dash_board.this,Manifest.permission.SEND_SMS) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Dash_board.this, new String[]{Manifest.permission.SEND_SMS}, 1);
        }
        ...
        Dashboard_AddTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent addTask = new Intent(Dash_board.this, AddTasks.class);
...
//                   Dashboard_petrol.setText(total);
       //         Toast.makeText(Dash_board.this, ""+total, Toast.LENGTH_SHORT).show();
                Dashboard_petrol.setText(""+ total);
               // Log.d("TAG", total + "");
            }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.Manage_Tasks:{
                Intent intent = new Intent(Dash_board.this, com.example.startechnical.Admin.Manage_Tasks.class);
                startActivity(intent);
                break;
        }
            case R.id.Manage_prof:{
                Intent manage_pr = new Intent(Dash_board.this, Manag_Profile.class);
                startActivity(manage_pr);
            break;}
            case R.id.Manag_finance:{
                Intent manage_finance = new Intent(Dash_board.this, ManageFinance.class);
                startActivity(manage_finance);
            break;}
            case R.id.Manag_Documents:{
                Intent manage_documents = new Intent(Dash_board.this, ManagDocuments.class);
                startActivity(manage_documents);
                break;}
            case R.id.Special_customer:{
                Intent manage_SpecCustomer = new Intent(Dash_board.this, ManagSpecialCustomer.class);
                startActivity(manage_SpecCustomer);
                break;}

            case R.id.nav_login:{
                Intent manage_login = new Intent(Dash_board.this, MainagLogins.class);
                startActivity(manage_login);
                break;
            }
            case R.id.nav_logout:{
                Intent manage_login = new Intent(Dash_board.this, SplashScreen.class);
                startActivity(manage_login);
                break;
            }
            case R.id.nav_Share:
