...
public class AdminAdapter extends FirebaseRecyclerAdapter<Adminmodule,AdminAdapter.AdminViewHolder> {
     ...
     */
    Context context;
    public AdminAdapter(@NonNull FirebaseRecyclerOptions<Adminmodule> options,Context context)
    {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull AdminViewHolder holder, int position, @NonNull Adminmodule model) {
