...
public class EmployeeAdapter extends FirebaseRecyclerAdapter<Employee, EmployeeAdapter.EmployeViewholder> {
    ...
    protected void onBindViewHolder(@NonNull EmployeViewholder holder, int position, @NonNull Employee model) {
           holder.Emp_name.setText(" E Name      : "+model.getEmployee_Name());
           holder.Emp_cnic.setText(" E Cnic      : "+model.getEmployeeCnic());
           holder.Emp_age.setText (" E Age       : "+model.getEmployeeAgge());
           holder.Emp_Gender.setText(" E Gender  : "+model.getEmployeeGender());
           holder.Emp_Adress.setText(" E Adess   : "+model.getEmployeeAdress());
           holder.Emp_roll.setText(" E Roll      : "+model.getEmployeeRoll());
           holder.Emp_phNo.setText(" E PhNo      : "+model.getEmployeePhNo());
           holder.Emp_Salary.setText(" E Salary  : "+model.getEmployeeSallary());
